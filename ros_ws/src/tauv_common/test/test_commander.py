...
from geometry_msgs.msg import AccelStamped, Vector3, Accel, Quaternion, Pose, Point
...
with patch('tauv_common.commander.Node.__init__'), \
...
class TestCommander(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('tauv_common.commander.Node.create_subscription') as mock_sub, \
    ...
    def _create_test_velocity_attitude_command(self, 
    ...
    def test_handle_nav_state_initial(self):
        ...
        np.testing.assert_array_equal(self.commander._filtered_angular_velocity, expected_angular_velocity)
    ...
    def test_handle_nav_state_filtering(self):
        ...
        self.assertAlmostEqual(self.commander._filtered_velocity[0, 0], expected_velocity_x, places=6)
        self.assertAlmostEqual(self.commander._filtered_angular_velocity[0, 0], expected_angular_velocity_x, places=6)
    ...
    def test_compute_velocity_control_with_derivative(self):
        ...
        np.testing.assert_array_equal(self.commander._previous_velocity, 
                                      self.commander._filtered_velocity)
    ...
    def test_attitude_control_method_exists(self):
        ...
        self.assertTrue(callable(getattr(self.commander, '_compute_attitude_control')))
    ...
    def test_velocity_control_only_integration(self):
        ...
        nav_msg = self._create_test_navigation_state()
        cmd_msg = self._create_test_velocity_attitude_command(
            velocity_enabled=True, attitude_enabled=False  # Only velocity control
        )
