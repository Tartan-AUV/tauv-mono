...
from tauv_common.controller import INDIController, INDIParams
...
class TestINDIParams(unittest.TestCase):
    ...
    def test_custom_params_creation(self):
        ...
        params = INDIParams(
            control_effectiveness=custom_G, accel_filter_alpha=0.5, max_force=200.0, max_torque=75.0
        )
...
class TestINDIControllerLogic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with (
            patch('tauv_common.controller.Node.__init__'),
...
class TestINDIControllerMessageHandling(unittest.TestCase):
    ...
    def test_handle_nav_state_with_filtering(self, mock_numpify):
        ...
        np.testing.assert_array_almost_equal(self.controller._filtered_accel[0:3], expected_linear)
...
class TestINDIControlAlgorithm(unittest.TestCase):
    ...
    def test_control_loop_initialization(self):
        ...
        with (
            patch('tauv_common.controller.numpify') as mock_numpify,
