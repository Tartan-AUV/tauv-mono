...
parser.add_argument(
    'left_path', type=Path, default=Path(Path.cwd() / 'left'), help='Path to left images'
)
parser.add_argument(
    'right_path', type=Path, default=Path(Path.cwd() / 'right'), help='Path to right images'
)
parser.add_argument(
    'max_dt_ms', type=float, default=100.0, help='Max time difference between images'
)
