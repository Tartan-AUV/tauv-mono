...
parser.add_argument("--target-node-id", default=125, type=int, help="Target CAN node ID (-1 for auto)")
...
parser.add_argument("--fw", default='/home/tauv/CANYAY/AP_Periph.bin', required=False, type=str, help="app firmware path")
