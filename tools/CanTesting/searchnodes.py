...
parser.add_argument("--target-node-id", default=125, type=int, help="target CAN node ID")
...
# parser.add_argument("--port", default="can0", type=str, help="CAN port")
args = parser.parse_args()

# Initializing a DroneCAN node instance.
node = dronecan.make_node("can1", node_id=args.node_id, bitrate=args.bitrate)
