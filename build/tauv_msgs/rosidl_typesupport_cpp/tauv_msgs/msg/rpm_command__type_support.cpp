...
static const _RpmCommand_type_support_symbol_names_t _RpmCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tauv_msgs, msg, RpmCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tauv_msgs, msg, RpmCommand)),
  }
};
...
{
  return &::tauv_msgs::msg::rosidl_typesupport_cpp::RpmCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tauv_msgs, msg, RpmCommand)() {
  return get_message_type_support_handle<tauv_msgs::msg::RpmCommand>();
}
