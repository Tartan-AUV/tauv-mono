...
bool tauv_msgs__msg__depth__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tauv_msgs.msg._depth.Depth", full_classname_dest, 26) == 0);
  }
  tauv_msgs__msg__Depth * ros_message = _ros_message;
  {  // header
...
PyObject * tauv_msgs__msg__depth__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tauv_msgs.msg._depth");
