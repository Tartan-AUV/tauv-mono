...
bool MS5837::readConversion(MS5837::ConversionType type) {
  ...
  uint8_t data[3];
  if (HAL_I2C_Master_Receive(_hi2c, MS5837_ADDR << 1, data, 3, HAL_MAX_DELAY) !=
      HAL_OK) {
    return false;
  }
  ...
  switch (type) {
    case ConversionType::MS5837_PRESSURE:
      D1_pres = result;
      return true;
    case ConversionType::MS5837_TEMPERATURE:
      D2_temp = result;
      return true;
    default:
      return false;
