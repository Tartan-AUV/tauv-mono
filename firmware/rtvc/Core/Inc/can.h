...
// XSens
// 400 Hz
#define CAN_MSG_ID_XSENS_SAMPLE_TIME 5
#define CAN_MSG_ID_XSENS_ORIENTATION_QUATERNION 11
#define CAN_MSG_ID_XSENS_RATE_OF_TURN 32
#define CAN_MSG_ID_XSENS_FREE_ACCELERATION 35
// 1 Hz
