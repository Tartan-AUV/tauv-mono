...
HD_PWD='/home/gleb/dev-shared/TAUV-ROS-Packages/firmware/AcousticsV2/HIL/ZyboStandalone/Acoustics_V2_HIL_Zybo_Standalone.runs/top_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
