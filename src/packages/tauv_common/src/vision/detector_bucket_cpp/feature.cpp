...
double FeatureTracker::getSimilarityCost(shared_ptr<Feature> F, FeatureDetection &det)
{
    ...
    return (distance+orientation+tagDist+freqDist+recDist)/total_weight + tracker_bias;
}
