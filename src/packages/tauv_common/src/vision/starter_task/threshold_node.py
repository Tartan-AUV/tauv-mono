...
from tauv_common.srv import SetThreshold, SetThresholdResponse

LOWER_THRESHOLD = np.array([0, 60, 60])
...
class ThresholdNode(): 
    def __init__(self):
        ...
        self._publisher = rospy.Publisher('starter_task/thresholded_img', Image, queue_size=5)
