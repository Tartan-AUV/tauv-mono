...
from tasks import dive, gate_dead_reckon, goto, goto_relative_with_depth, buoy_24, surface
...
class KFIrvineSemis2(Mission):
    ...
    def __init__(self):
        ...
        self._gate_t_buoy: SE3 = SE3.Rt(SO3(), (4.57, -3.66, 0.75))
    ...
    def transition(self, task: Task, task_result: TaskResult) -> Optional[Task]:
        if self._state == State.DIVE:
            ...
            if task_result.status == goto.GotoStatus.SUCCESS:
                ...
                return buoy_24.CircleBuoy('buoy_24', circle_radius=3.0, circle_ccw=False, waypoint_every_n_meters=0.75)
