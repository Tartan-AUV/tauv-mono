...
namespace sf
{
    ...
    public:
        ...
        // Accept tauv ThrusterSetpoint messages directly (adapter replacement)
        void ThrustersTauvCallback(const tauv_msgs::msg::ThrusterSetpoint::SharedPtr msg, std::shared_ptr<ROS2Robot> robot);
