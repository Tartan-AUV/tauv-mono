...
class SetThrusterManagerConfigRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.base_link);
    length += _getByteLength(object.thruster_frame_base);
    length += _getByteLength(object.thruster_topic_prefix);
    length += _getByteLength(object.thruster_topic_suffix);
    return length + 32;
  }
...
module.exports = {
  ...
  datatype() { return 'tauv_common/SetThrusterManagerConfig'; }
};
