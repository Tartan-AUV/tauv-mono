...
(cl:defmethod cl:initialize-instance :after ((m <GetThrusterManagerConfig-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetThrusterManagerConfig-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tauv_common-srv:<GetThrusterManagerConfig-request> is deprecated: use tauv_common-srv:GetThrusterManagerConfig-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetThrusterManagerConfig-request>)))
  ...
  "tauv_common/GetThrusterManagerConfigRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetThrusterManagerConfig-request)))
  "Returns string type for a service object of type 'GetThrusterManagerConfig-request"
  "tauv_common/GetThrusterManagerConfigRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetThrusterManagerConfig-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetThrusterManagerConfig-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tauv_common-srv:<GetThrusterManagerConfig-response> is deprecated: use tauv_common-srv:GetThrusterManagerConfig-response instead.")))

(cl:ensure-generic-function 'tf_prefix-val :lambda-list '(m))
(cl:defmethod tf_prefix-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:tf_prefix-val is deprecated.  Use tauv_common-srv:tf_prefix instead.")
  (tf_prefix m))

(cl:ensure-generic-function 'base_link-val :lambda-list '(m))
(cl:defmethod base_link-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:base_link-val is deprecated.  Use tauv_common-srv:base_link instead.")
  (base_link m))
...
(cl:defmethod thruster_frame_base-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:thruster_frame_base-val is deprecated.  Use tauv_common-srv:thruster_frame_base instead.")
...
(cl:defmethod thruster_topic_prefix-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:thruster_topic_prefix-val is deprecated.  Use tauv_common-srv:thruster_topic_prefix instead.")
...
(cl:defmethod thruster_topic_suffix-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:thruster_topic_suffix-val is deprecated.  Use tauv_common-srv:thruster_topic_suffix instead.")
  (thruster_topic_suffix m))

(cl:ensure-generic-function 'timeout-val :lambda-list '(m))
(cl:defmethod timeout-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:timeout-val is deprecated.  Use tauv_common-srv:timeout instead.")
  (timeout m))

(cl:ensure-generic-function 'max_thrust-val :lambda-list '(m))
(cl:defmethod max_thrust-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:max_thrust-val is deprecated.  Use tauv_common-srv:max_thrust instead.")
  (max_thrust m))

(cl:ensure-generic-function 'n_thrusters-val :lambda-list '(m))
(cl:defmethod n_thrusters-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:n_thrusters-val is deprecated.  Use tauv_common-srv:n_thrusters instead.")
  (n_thrusters m))
...
(cl:defmethod allocation_matrix-val ((m <GetThrusterManagerConfig-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:allocation_matrix-val is deprecated.  Use tauv_common-srv:allocation_matrix instead.")
  (allocation_matrix m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetThrusterManagerConfig-response>)))
  ...
  "tauv_common/GetThrusterManagerConfigResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetThrusterManagerConfig-response)))
  "Returns string type for a service object of type 'GetThrusterManagerConfig-response"
  "tauv_common/GetThrusterManagerConfigResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetThrusterManagerConfig)))
  ...
  "tauv_common/GetThrusterManagerConfig")