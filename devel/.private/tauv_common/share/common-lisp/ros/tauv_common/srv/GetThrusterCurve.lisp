...
(cl:defmethod cl:initialize-instance :after ((m <GetThrusterCurve-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetThrusterCurve-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tauv_common-srv:<GetThrusterCurve-request> is deprecated: use tauv_common-srv:GetThrusterCurve-request instead.")))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <GetThrusterCurve-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:min-val is deprecated.  Use tauv_common-srv:min instead.")
  (min m))

(cl:ensure-generic-function 'max-val :lambda-list '(m))
(cl:defmethod max-val ((m <GetThrusterCurve-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:max-val is deprecated.  Use tauv_common-srv:max instead.")
  (max m))

(cl:ensure-generic-function 'n_points-val :lambda-list '(m))
(cl:defmethod n_points-val ((m <GetThrusterCurve-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:n_points-val is deprecated.  Use tauv_common-srv:n_points instead.")
  (n_points m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetThrusterCurve-request>)))
  ...
  "tauv_common/GetThrusterCurveRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetThrusterCurve-request)))
  "Returns string type for a service object of type 'GetThrusterCurve-request"
  "tauv_common/GetThrusterCurveRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetThrusterCurve-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetThrusterCurve-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tauv_common-srv:<GetThrusterCurve-response> is deprecated: use tauv_common-srv:GetThrusterCurve-response instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <GetThrusterCurve-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:input-val is deprecated.  Use tauv_common-srv:input instead.")
  (input m))

(cl:ensure-generic-function 'thrust-val :lambda-list '(m))
(cl:defmethod thrust-val ((m <GetThrusterCurve-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_common-srv:thrust-val is deprecated.  Use tauv_common-srv:thrust instead.")
  (thrust m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetThrusterCurve-response>)))
  ...
  "tauv_common/GetThrusterCurveResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetThrusterCurve-response)))
  "Returns string type for a service object of type 'GetThrusterCurve-response"
  "tauv_common/GetThrusterCurveResponse")
