...
(defsystem "uuv_gazebo_ros_plugins_msgs-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "GetListParam" :depends-on ("_package_GetListParam"))
    (:file "_package_GetListParam" :depends-on ("_package"))
    (:file "GetModelProperties" :depends-on ("_package_GetModelProperties"))
    (:file "_package_GetModelProperties" :depends-on ("_package"))
    (:file "GetThrusterConversionFcn" :depends-on ("_package_GetThrusterConversionFcn"))
    (:file "_package_GetThrusterConversionFcn" :depends-on ("_package"))
